...
local Response = game:HttpGet("https://raw.githubusercontent.com/Steven55704/idklmaoxd/main/words.txt")
local Words = {}
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Steven55704/idklmaoxd/main/idkgui.lua"))()
